...
public class PrintHeap1 {

    public static void treePrint(MaxHeap1 heap) {
        treePrint(heap.getCount(), heap.getArr());
    }

    public static void treePrint(int count, int[] arr) {
        ...
        System.out.println("The max heap size is: " + count);
        ...
        for (int level = 0; level < maxLevel; level++) {
            ...
            for (int indexCurLevel = 0; indexCurLevel < curLevelNumber; index++, indexCurLevel++) {
                line1 = putNumberInLine(arr[index], line1, indexCurLevel, curTreeMaxLevelNumber * 3 - 1, isLeft);
                isLeft = !isLeft;
            }
